...
var G__54440 = o;
goog.object.set(G__54440,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__54472__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__54472 = function (var_args){
var args = null;
...
while (G__54473__i < G__54473__a.length) {G__54473__a[G__54473__i] = arguments[G__54473__i + 0]; ++G__54473__i;}
  args = new cljs.core.IndexedSeq(G__54473__a,0,null);
} 
return G__54472__delegate.call(this,args);};
G__54472.cljs$lang$maxFixedArity = 0;
G__54472.cljs$lang$applyTo = (function (arglist__54474){
var args = cljs.core.seq(arglist__54474);
return G__54472__delegate(args);
});
G__54472.cljs$core$IFn$_invoke$arity$variadic = G__54472__delegate;
return G__54472;
})()
;
} else {
...
var G__54447 = o;
goog.object.set(G__54447,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__54477__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__54477 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__54478__i = 0, G__54478__a = new Array(arguments.length -  0);
while (G__54478__i < G__54478__a.length) {G__54478__a[G__54478__i] = arguments[G__54478__i + 0]; ++G__54478__i;}
  args = new cljs.core.IndexedSeq(G__54478__a,0,null);
} 
return G__54477__delegate.call(this,args);};
G__54477.cljs$lang$maxFixedArity = 0;
G__54477.cljs$lang$applyTo = (function (arglist__54479){
var args = cljs.core.seq(arglist__54479);
return G__54477__delegate(args);
});
G__54477.cljs$core$IFn$_invoke$arity$variadic = G__54477__delegate;
return G__54477;
})()
;
} else {
...
var G__54448 = props;
var G__54448__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54448,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__54448);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54448__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__54448__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__54449 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54449,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__54449;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__54451){
var map__54452 = p__54451;
var map__54452__$1 = cljs.core.__destructure_map(map__54452);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54452__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__54453_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__54453_SHARP_);
}));
} else {
return null;
}
...
var vec__54457 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54457,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54457,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54457,(2),null);
...
var temp__5758__auto___54483 = reagent.impl.template.key_from_vec(v);
if((temp__5758__auto___54483 == null)){
} else {
var key_54484 = temp__5758__auto___54483;
(jsprops.key = key_54484);
}
...
var temp__5758__auto___54486 = reagent.impl.template.key_from_vec(argv);
if((temp__5758__auto___54486 == null)){
} else {
var key_54487 = temp__5758__auto___54486;
(jsprops.key = key_54487);
}
...
var G__54461 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__54461) : reagent.impl.template.as_element.call(null,G__54461));
} else {
var temp__5758__auto___54489 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5758__auto___54489 == null)){
} else {
var key_54490 = temp__5758__auto___54489;
(jsprops.key = key_54490);
}
...
var G__54463 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__54463)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__54463)){
return x;
} else {
...
var len__4829__auto___54491 = arguments.length;
var i__4830__auto___54492 = (0);
while(true){
if((i__4830__auto___54492 < len__4829__auto___54491)){
args__4835__auto__.push((arguments[i__4830__auto___54492]));

var G__54493 = (i__4830__auto___54492 + (1));
i__4830__auto___54492 = G__54493;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq54464){
var G__54465 = cljs.core.first(seq54464);
var seq54464__$1 = cljs.core.next(seq54464);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54465,seq54464__$1);
}));
...
break;
default:
var G__54495 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__54495;
continue;
...
var ctx = ({});
var vec__54468 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54468,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54468,(1),null);
...
var G__54471 = (cljs.core.count(argv) - first_child);
switch (G__54471) {
case (0):
