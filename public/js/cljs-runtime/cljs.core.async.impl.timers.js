...
var i_47455 = (0);
while(true){
if((i_47455 < arr.length)){
(arr[i_47455] = null);

var G__47456 = (i_47455 + (1));
i_47455 = G__47456;
continue;
} else {
}
...
var i_47463 = (self__.level + (1));
while(true){
if((i_47463 <= (new_level + (1)))){
(update[i_47463] = self__.header);

var G__47464 = (i_47463 + (1));
i_47463 = G__47464;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_47465 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_47465[i]));
} else {
x__$2.forward.push((((i < links_47465.length))?(links_47465[i]):null));
}

if((i < links_47465.length)){
(links_47465[i] = x__$2);
} else {
links_47465.push(x__$2);
}
...
var i_47467 = (0);
while(true){
if((i_47467 <= self__.level)){
var links_47468 = (update[i_47467]).forward;
if((x__$1 === (((i_47467 < links_47468.length))?(links_47468[i_47467]):null))){
(links_47468[i_47467] = (x__$1.forward[i_47467]));

var G__47469 = (i_47467 + (1));
i_47467 = G__47469;
continue;
} else {
var G__47470 = (i_47467 + (1));
i_47467 = G__47470;
continue;
}
} else {
...
var G__47472 = nx;
var G__47473 = (level__$1 - (1));
x = G__47472;
level__$1 = G__47473;
continue;
} else {
var G__47474 = x;
var G__47475 = (level__$1 - (1));
x = G__47474;
level__$1 = G__47475;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__47477 = nx;
var G__47478 = (level__$1 - (1));
x = G__47477;
level__$1 = G__47478;
continue;
} else {
var G__47479 = x;
var G__47480 = (level__$1 - (1));
x = G__47479;
level__$1 = G__47480;
continue;
}
